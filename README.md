...
| `price_check_interval` | Anhoch, DDStore, Neksio, Neptun, or Setec only; Reklama5 does not support it. Set to `3600` for hourly price checks; omit or set to `null` to disable. |
