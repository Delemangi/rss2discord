...
Forward RSS/Atom feeds, XenForo thread posts, IT.mk Oglasnik, Pazar3, and Reklama5 listings, and Anhoch, DDStore, Neksio, Neptun, or Setec product updates to Discord webhooks.
...
- SQLite delivery history and persistent price snapshots for Anhoch, DDStore, Neksio, Neptun, Pazar3, Reklama5, and Setec
...
| `price_check_interval` | Anhoch, DDStore, Neksio, Neptun, Pazar3, Reklama5, or Setec only. Set to `3600` for hourly price checks; omit or set to `null` to disable. |
